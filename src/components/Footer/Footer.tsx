...
const Footer = () => {
  return (
    ...
    <div className="px-4 py-6 bg-gradient-to-b from-[#474747] bg-[#2e2e2e] dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-300 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">CrystalCoaching</a>. All Rights Reserved.
        Designed by <a className="text-blue-500 hover:text-blue-300" href="https://www.luitomania.com">Luitomania</a> </span>
